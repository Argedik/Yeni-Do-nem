...
function varsayilanVeri() {
  return {
    ...
    isler: [
      ...
      { id: yeniId(), ad: 'Güncel listeyi düzenle (yeni katılım / görev değişikliği)', kategori: 'Liste', tip: 'surekli', aciklama: 'Ekibe yeni katılan hanım, görev değişikliği veya ayrılma olduğunda Drive\'daki listeyi güncelle.', link: '' },
    ],
    toplantilar: [],
    linkler: [
    ...
    surum: 12,     // veri şeması sürümü (göç için)
  };
}
